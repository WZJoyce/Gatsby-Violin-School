  ...
  return (
    <StaticQuery
      ...
      render={data => {
        ...
        // Type WebPage: for all pages that aren't posts
        if (!isArticle) {
          schemaOrgWebPage = {
            ...
            datePublished: "2020-11-13T00:00:00+02:00",
        ...
        // Type BlogPosting: for all pages that are  posts
        if (isArticle) {
          schemaOrgBlogPosting = {
        ...
        // include  post page if this is a post
        if (isArticle) {
